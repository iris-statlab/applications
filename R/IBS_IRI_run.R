...
# Fuction to run IRI pipeline and IRI estimation
iri_fun<-function(db,df2,alpha){
  ...
  source(".R/main/JQM_Function_FE.R")
...
##################################################################################
# run pipeline in healthy individuals
ibs<-ibs_all_h
...
##################################################################################
# run pipeline in IBS-C patients
ibs<-ibs_all_c
ibs<-ibs[,c(1:2,8:9,3:7,10:28)]
...
##################################################################################
# run pipeline in IBS-D patients
ibs<-ibs_all_d
ibs<-ibs[,c(1:2,8:9,3:7,10:28)]
